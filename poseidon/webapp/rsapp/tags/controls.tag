<controls class="tile, is-ancestor, is-vertical">
    <div each={ row in opts.controls } class="tile">
        <div each={ control in row } class="tile is-parent">
          <directioncontrol if={ control.type == "directioncontrol" || !control.type } class="tile is-child box" title={ control.title } range={ opts.range || {} } update={ control.update } horizontal={ control.horizontal }></directioncontrol>
