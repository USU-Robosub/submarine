...
TEST_CASE("BlueRoboticsR1Esc starts disabled", "[BlueRoboticsR1Esc]"){
  Servo::$reset();
  Components::Motors::BlueRoboticsR1Esc motor({.pin=TEST_PIN, .trim={0, 0, 0, 0}});
...
TEST_CASE("BlueRoboticsR1Esc motor can be enabled and disabled", "[BlueRoboticsR1Esc]"){
  Servo::$reset();
  Components::Motors::BlueRoboticsR1Esc motor({.pin=TEST_PIN, .trim={0, 0, 0, 1}});
...
TEST_CASE("BlueRoboticsR1Esc no trimming", "[BlueRoboticsR1Esc]"){
  Servo::$reset();
  Components::Motors::BlueRoboticsR1Esc motor({.pin=TEST_PIN, .trim={-1, 0, 0, 1}});
  motor.enable();
...
TEST_CASE("BlueRoboticsR1Esc trim out forward", "[BlueRoboticsR1Esc]"){
  Servo::$reset();
  Components::Motors::BlueRoboticsR1Esc motor({.pin=TEST_PIN, .trim={-1, 0, 0, 0}});
  motor.enable();
...
TEST_CASE("BlueRoboticsR1Esc reduce top speed with trim", "[BlueRoboticsR1Esc]"){
  Servo::$reset();
  Components::Motors::BlueRoboticsR1Esc motor({.pin=TEST_PIN, .trim={-0.5, 0, 0, 0.2}});
  motor.enable();
